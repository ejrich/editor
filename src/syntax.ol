Syntax* get_syntax_for_file(string file_path) {
    ...
    result: Syntax*;
    if extension_start < file_path.length {
        extension: string = {
...
syntax_configurations: Array<Syntax> = [
    ...
    },
    {
        ...
        keywords = [
            ...
            { value = "const";            color = SyntaxColor.Orange; },
            { value = "constexpr";        color = SyntaxColor.Orange; },
            { value = "const_cast";       color = SyntaxColor.Red; },
            { value = "continue";         color = SyntaxColor.Red; },
            { value = "decltype";         color = SyntaxColor.Orange; },
            { value = "default";          color = SyntaxColor.Red; },
            ...
            { value = "thread_local";     color = SyntaxColor.Orange; },
